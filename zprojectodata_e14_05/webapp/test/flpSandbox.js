		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zprojectodatae1405-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectodatae1405-display": {
								"semanticObject": "zprojectodatae1405",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectodatae1405",
									"url": sap.ui.require.toUrl("zprojectodatae1405")
								}
							}
						}
					}
