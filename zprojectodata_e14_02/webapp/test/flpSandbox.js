		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zprojectodatae1402-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectodatae1402-display": {
								"semanticObject": "zprojectodatae1402",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectodatae1402",
									"url": sap.ui.require.toUrl("zprojectodatae1402")
								}
							}
						}
					}
