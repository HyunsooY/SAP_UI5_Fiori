		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "EReON 결재",
									"targetURL": "#ERzferapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ERzferapproval-display": {
								"semanticObject": "ERzferapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ER.zferapproval",
									"url": sap.ui.require.toUrl("ER/zferapproval")
								}
							}
						}
					}
