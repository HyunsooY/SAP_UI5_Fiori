		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "EReON 회원가입",
									"targetURL": "#ERzfermembership-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ERzfermembership-display": {
								"semanticObject": "ERzfermembership",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ER.zfermembership",
									"url": sap.ui.require.toUrl("ER/zfermembership")
								}
							}
						}
					}
