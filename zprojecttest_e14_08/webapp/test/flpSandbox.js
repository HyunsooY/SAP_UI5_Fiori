		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chart",
									"targetURL": "#zprojectteste1408-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectteste1408-display": {
								"semanticObject": "zprojectteste1408",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectteste1408",
									"url": sap.ui.require.toUrl("zprojectteste1408")
								}
							}
						}
					}
