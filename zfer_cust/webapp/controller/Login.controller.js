sap.ui.define([
    ...
    function (Controller, JSONModel, Fragment, MessageBox, CoreLibrary, Filter, Dialog, Button, Text, TextArea) {
        ...
        return Controller.extend("ER.zfercust.controller.Login", {
            formatter: {
                        ...
                        error: function() {   
                            if (!this._pDialog) {
                                this._pDialog = Fragment.load({
                                    id: oView.getId(),
                                    name: "ER.zfercust/view/fragment/Rental",
                                    controller: this
            ...
            onRentalCancel: function() {
                ...
                if(!this.byId("idCancelDialog")){
                    Fragment.load({
                        id: oView.getId(),
                        name: "ER.zfercust/view/fragment/Cancel",
                        controller: this
                    }).then(function (oDialog) {
                        oView.addDependent(oDialog);
                        oDialog.open();
                    ...
                    success: function(oReturn){
                        ...
                        if(oToday >= oRndate){
                            ...
                            if(!this.byId("idReturnDialog")){
                                Fragment.load({
                                    id: oView.getId(),
                                    name: "ER.zfercust/view/fragment/Return",
                                    controller: this
                                }).then(function (oDialog) {
                                    oView.addDependent(oDialog);
                                    oDialog.open();
