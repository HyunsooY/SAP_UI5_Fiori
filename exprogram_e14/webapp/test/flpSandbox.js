		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#exprograme14-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exprograme14-display": {
								"semanticObject": "exprograme14",
								"action": "display",
								"description": "Exam",
								"title": "App Title",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exprograme14",
									"url": sap.ui.require.toUrl("exprograme14")
								}
							}
						}
					}
