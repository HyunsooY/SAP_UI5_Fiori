            ...
            onInit: function () {
                ...
                this.oModel.read('/LoginSet', {
                    success: function(oReturn) {
                        ...
                        if(_rootPath){
                            this.byId("idLoginImage").setSrc(_rootPath+'/model/image/employee/'+oReturn.results[0].Sapid+'.png');
                        }else{
                            this.byId("idLoginImage").setSrc('/model/image/employee/'+oReturn.results[0].Sapid+'.png');
                        }
                    }.bind(this)
                });
