		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "EReON 결재",
									"targetURL": "#ERzferdocuapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ERzferdocuapproval-display": {
								"semanticObject": "ERzferdocuapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ER.zferdocuapproval",
									"url": sap.ui.require.toUrl("ER/zferdocuapproval")
								}
							}
						}
					}
