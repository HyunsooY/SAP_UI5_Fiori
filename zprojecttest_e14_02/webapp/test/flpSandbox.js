		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#C05zprojectteste1402-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"C05zprojectteste1402-display": {
								"semanticObject": "C05zprojectteste1402",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=C05.zprojectteste1402",
									"url": sap.ui.require.toUrl("C05/zprojectteste1402")
								}
							}
						}
					}
